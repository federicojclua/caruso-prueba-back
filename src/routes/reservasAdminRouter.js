...
const reservasController = require('../controllers/reservaController'); // Cambia a 'reservaController'
const checkRole = require('../middlewares/checkRole');

const router = express.Router();

// Proteger todas las rutas de administración con autenticación y autorización
router.use(require('../middlewares/authMiddleware'));

// GET /api/reservas/admin: Obtener todas las reservas (solo para administrador)
router.get('/', checkRole('admin'), reservasController.obtenerReservas);
